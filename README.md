...
Проект был выполнен на инфраструктуре учебного курса, поэтому в ходе его выполнения были использованы заренее сконфигурированые подключения (например, connections в airflow к Greenplum и Kubernetes Cluster).
